...
* remove unnecessary config options by @YewFence
* remove CHANGELOG.md during initialization by @YewFence

**Full Changelog**: https://github.com/YewFence/go-cli-template/compare/v0.2.1...v0.3.0
